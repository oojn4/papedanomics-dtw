...
export function IntroMethod() {
  ...
  return (
    ...
    <Image src="framework.png"  style={{width:750, alignItems:'center', position: 'relative', left:250}}/>
